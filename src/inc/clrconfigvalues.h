...
RETAIL_CONFIG_DWORD_INFO(INTERNAL_STATIC_BUCKET_SIZE, W("StaticBucketSize"), 1020, "Make STATIC_OBJECT_TABLE_BUCKET_SIZE configurable")
RETAIL_CONFIG_DWORD_INFO(INTERNAL_STRING_BUCKET_SIZE, W("StringBucketSize"), 128, "Make GLOBAL_STRING_TABLE_BUCKET_SIZE configurable")
